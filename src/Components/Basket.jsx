...
const BasketBox = (props) => {
  console.log("basket render edildi")
  ...
  return (
    <section ref={basketRef} className="py-4 absolute right-0 top-16 w-full max-w-md mx-auto bg-white rounded-lg shadow-lg h-[400px] overflow-y-auto">
